...
public class ElinahDialogue : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("After I dropped my bag yesterday evening, I thought I saw an animal take it into this tunnel. I don�t think I could reach it, but maybe you can?", "Elinah"));
        ...
        dialogTexts.Add(new DialogData("Protecting forests like these is one of the main topics of our protest today!", "Elinah"));
        ...
        dialogTexts.Add(new DialogData("Oh no, do you hear that? They will try to block me on the road ahead. The PBI handbook says we should find an alternate escape route, so we can avoid a dangerous situation.", "Elinah"));
